...
@[else]@
# CUDA installation skipped: host already has NVIDIA drivers installed.
# This avoids reinstalling CUDA when the host drivers are present (fixes issue #316).
@[end if]@
